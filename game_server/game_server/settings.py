...
SECRET_KEY = 'django-insecure-*=6$r17+@%2)lr&4mdj85&_axv+^$3#70j4_=yu0rq76_&+3+_'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'three', # Nombre de la base de datos
        'USER': 'root',  # Usuario de la base de datos
        'PASSWORD': 'root',  # Contraseña de la base de datos
        'HOST': 'db-three-api',  # Nombre del servicio del contenedor de PostgreSQL en el docker-compose
